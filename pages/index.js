    ...
    <div className={`relative ${data.showCursor && "cursor-none"}`}>
      ...
      <div className="container mx-auto mb-10">
        ...
        <div className="mt-20 laptop:mt-30 p-2 laptop:p-0">
          <h1 className="tablet:m-10 text-3xl text-bold">Work Experience.</h1>
          <div className="mt-5 tablet:m-10 grid grid-cols-1 gap-6">
        ...
        <div className="mt-20 laptop:mt-30 p-2 laptop:p-0" ref={workRef}>
          <h1 className="tablet:m-10 text-3xl text-bold">Project.</h1>
